...
class Omok(object):
    ...
    def set_image_font(self):
        ...
        black_img = pygame.image.load(os.path.join(image_path,'black.png'))
        white_img = pygame.image.load(os.path.join(image_path,'white.png'))
        self.last_w_img = pygame.image.load(os.path.join(image_path,'white_a.png'))
        self.last_b_img = pygame.image.load(os.path.join(image_path,'black_a.png'))
        self.board_img = pygame.image.load(os.path.join(image_path,'board.png'))
